#!/usr/bin/env python
#Functions to do basic quake cataloge analysis 
...
def get_hist_mt(t1, t2, llat = '-90', ulat = '90', llon = '-180', ulon = '180', 
    ...
    outfilename = 'globalcmt_'+str(t1)+'_'+str(t2)+'_.dat'
    ...
    data =  page.read()
    endcut = data.rfind('</pre>')
    startcut =  data[:endcut].rfind('</h2>')
    outfile.write(data[startcut+5:endcut])
    outfile.close()
